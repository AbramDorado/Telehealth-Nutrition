            ...
            return DB::table('code_blue_activations')
                ...
                ->select(
                    ...
                    DB::raw("TRIM(BOTH ', ' FROM CONCAT(
                        ...
                        NULLIF(CASE WHEN evaluations.question3_3 = 'Absent' THEN 'Suction' ELSE '' END, ''),                        NULLIF(CASE WHEN evaluations.question3_4 = 'Malfunctioning' THEN 'Medications' ELSE '' END, ''),
