            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="food_recall_time" value="{{ old('food_recall_time', optional($diethistory)->food_recall_time ? \Carbon\Carbon::parse(optional($diethistory)->food_recall_time)->format('Y-m-d\TH:i') : '') }}">
                    </div>
